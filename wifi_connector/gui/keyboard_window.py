...
class KeyboardWindow(QMainWindow, keyboard_window):
	...
	def __init__(self, callback=None, parent=None):
		...
		self.buttons = [
			self.btnu1, self.btnu2, self.btnu3, self.btnu4, self.btnu5, self.btnu6, self.btnu7, self.btnu8, self.btnu9, self.btnu0,
			...
			self.btn_upper, self.btn_underscore, self.btn_score, self.btn_space, self.btn_period, self.btn_backspace, self.btn_ok
		]
	...
	def setup_listener(self):
		...
		self.btnu1.clicked.connect(self.btnu1_clicked)
		self.btnu2.clicked.connect(self.btnu2_clicked)
		self.btnu3.clicked.connect(self.btnu3_clicked)
		self.btnu4.clicked.connect(self.btnu4_clicked)
		self.btnu5.clicked.connect(self.btnu5_clicked)
		self.btnu6.clicked.connect(self.btnu6_clicked)
		self.btnu7.clicked.connect(self.btnu7_clicked)
		self.btnu8.clicked.connect(self.btnu8_clicked)
		self.btnu9.clicked.connect(self.btnu9_clicked)
		self.btnu0.clicked.connect(self.btnu0_clicked)
		...
		self.btn_score.clicked.connect(self.btn_score_clicked)
	...
	def btnu1_clicked(self):
		self.keys += self.btnu1.text()
		self.reflect_keys()

	def btnu2_clicked(self):
		self.keys += self.btnu2.text()
		self.reflect_keys()

	def btnu3_clicked(self):
		self.keys += self.btnu3.text()
		self.reflect_keys()

	def btnu4_clicked(self):
		self.keys += self.btnu4.text()
		self.reflect_keys()

	def btnu5_clicked(self):
		self.keys += self.btnu5.text()
		self.reflect_keys()

	def btnu6_clicked(self):
		self.keys += self.btnu6.text()
		self.reflect_keys()

	def btnu7_clicked(self):
		self.keys += self.btnu7.text()
		self.reflect_keys()

	def btnu8_clicked(self):
		self.keys += self.btnu8.text()
		self.reflect_keys()

	def btnu9_clicked(self):
		self.keys += self.btnu9.text()
		self.reflect_keys()

	def btnu0_clicked(self):
		self.keys += self.btnu0.text()
		self.reflect_keys()
	...
	def btn_score_clicked(self):
		self.keys += self.btn_score.text()
		self.reflect_keys()
